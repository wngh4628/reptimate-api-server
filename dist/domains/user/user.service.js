...
let UserService = class UserService {
    constructor(userRepository, emailService, redisService) {
    ...
    async createSocialUser(email, nickname, socialType) {
        ...
        user.loginMethod =
            socialType === 'KAKAO' ? constants_1.SocialMethodType.KAKAO : socialType === 'GOOGLE' ? constants_1.SocialMethodType.GOOGLE : constants_1.SocialMethodType.APPLE;
        return await this.userRepository.save(user);
    }
    ...
    async sendMemberJoinEmail(dto) {
        const signupVerifyToken = uuid.v1();
        if (dto.type === constant_1.EmailVerifyType.OLDUSER) {
